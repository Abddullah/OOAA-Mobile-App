  ...
  render() {
    return (
      ...
      <ScrollView style={{ flex: 1, }}>
        ...
        <View style={[styles.card, { backgroundColor: this.props.themeColors.backGroundColor }]}>
            ...
            <View style={[styles.btn_normal, { backgroundColor: this.props.themeColors.backGroundColor }]}>
              <Tooltip
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ color: this.props.themeColors.forGroundColor, }}>45%</Text>
                </TouchableOpacity>
              </Tooltip>
            </View>
            ...
            <View style={[styles.btn_normal, { backgroundColor: this.props.themeColors.backGroundColor }]}>
              <Tooltip
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ color: this.props.themeColors.forGroundColor, }}>13%</Text>
                </TouchableOpacity>
              </Tooltip>
            </View>
          </View>
